...
function Article({ article }) {
  ...
  const cardStyle = location === 'ArticlesList' ? styles.preview : classNames(styles.preview, styles.singleCard)
  ...
  useEffect(() => {
    if (location === 'ArticlePage') dispatch(setGoTo(''))
  }, [])
  ...
  return (
    <div className={styles.cardWrapper}>
        ...
        <section className={styles.info}>
          <div className={styles.authInfo}>
            ...
            <img
              ...
              onError={() => setAvatar(noDataImage)}
            />
          </div>
          {location === 'ArticlePage' && article.username === username && (
      ...
      {location === 'ArticlePage' && <ReactMarkdown children={article.text} className={styles.pageText} />}
